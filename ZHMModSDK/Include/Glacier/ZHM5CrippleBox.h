...
public:
    ...
    bool m_bVRTurn; // 0x52
    bool m_bVRThrow; // 0x53
    bool m_bRun; // 0x54
    bool m_bTurn; // 0x55
    bool m_bSneak; // 0x56
    bool m_bNoSnapSneak; // 0x57
    bool m_bStandUp; // 0x58
    bool m_bFastWalk; // 0x59
    bool m_bMovementAllowed; // 0x5A
    bool m_bIdleAnimationsAllowed; // 0x5B
    bool m_bItems; // 0x5C
    bool m_bCanHolsterItems; // 0x5D
    bool m_bCoverTakedown; // 0x5E
    bool m_bCoverScale; // 0x5F
    bool m_bCoverToCover; // 0x60
    bool m_bCloseCombatSnapNeck; // 0x61
    bool m_bCloseCombatChoke; // 0x62
    bool m_bCloseCombatPistolFinish; // 0x63
    bool m_bCloseCombatProps; // 0x64
    bool m_bCloseCombatStandard; // 0x65
    bool m_bCloseCombatFakeSwing; // 0x66
    bool m_bGameCameraAutoAlign; // 0x67
    bool m_bCameraSide; // 0x68
    bool m_bNotSelfieMode; // 0x69
    bool m_bInstinct; // 0x6A
    bool m_bBlindFire; // 0x6B
    bool m_bAim; // 0x6C
    bool m_bHairTrigger; // 0x6D
    bool m_bFire; // 0x6E
