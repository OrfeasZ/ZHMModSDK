...
namespace Util {
    ...
    public:
         ...
         * @tparam GetOptionValueFn       (Optional) Function or lambda returning an additional value passed to OnSelectFn.
         *
         ...
         * @param p_GetOptionNameFn       Function used to extract the display name.
         * @param p_OnSelectFn            Callback executed when an option is selected.
         * @param p_GetOptionValueFn      (Optional) Function that retrieves a value passed to the selection callback.
