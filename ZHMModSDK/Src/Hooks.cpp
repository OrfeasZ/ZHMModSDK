...
PATTERN_HOOK(
	"\x48\x89\x4C\x24\x08\x55\x53\x56\x57\x41\x54\x41\x55\x41\x57\x48\x8D\xAC\x24\x80\xE6\xFF\xFF",
...
PATTERN_CALL_HOOK(
	"\xE8\x00\x00\x00\x00\x49\x8B\xCF\xE8\x00\x00\x00\x00\x49\x8B\x8E\xC0\x07\x00\x00",
	"x????xxxx????xxxxxxx",
