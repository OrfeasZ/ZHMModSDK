...
private:
	...
	static void SendEntitiesDetails(WebSocket* p_Socket, std::vector<std::tuple<std::string, EulerAngles, ZEntityRef>> p_Entities);
	...
	static void WriteEntityTransforms(std::ostream& p_Stream, EulerAngles p_EulerAngles, ZEntityRef p_Entity);
