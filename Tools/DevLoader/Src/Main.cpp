...
int main(int argc, char** argv)
{
	...
	// TODO: Get this from ENV or args.
	std::filesystem::path s_HitmanPath("O:\\Games\\HITMAN3");
	...
	else
	{
		...
		std::string s_CommandLine = "-epicapp=Eider -epicenv=Prod -EpicPortal -epicusername=NoFaTe -epicuserid=29438d6d19854c498ff2e7b77e2e5c07 -epiclocale=en";
